...
*/
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 ">
        ...
        <div className="flex justify-center items-center mb-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-center w-full">
            <input
              ...
              className="px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 w-full md:w-full"
            />
            <select
              value={category}
            ...
            <button
              ...
              className="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors w-full md:w-full"
            >
              Apply
            </button>
          </div>
      ...
      {status === "authenticated" && session?.user?.role === "member" && (
        <Link
